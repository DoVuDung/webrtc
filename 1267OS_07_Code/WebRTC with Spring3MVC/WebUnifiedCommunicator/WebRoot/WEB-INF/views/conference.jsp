...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<c:url value="resources/metroui/css/style2.css"/>" type="text/css" />
     ...
     <body>
              ...
              <select id="session" title="Session">
                      <option selected>Select mode of Conferencing</option>
                        ...
                        <option>audio</optst.get(i).getPrivateIdentity().toString()%>&nbsp;	&nbsp;	&nbsp;	&nbsp;
										</td>ion>
                        <option>video</option>
                        <option>data</option>
              ...
              <section class="experiment dst.get(i).getPrivateIdentity().toString()%>&nbsp;	&nbsp;	&nbsp;	&nbsp;
										</td>ata-box">
            ...
            <script>
                ...
                connection.openSignalingChannel = function(config) {
                    ...
                    var websocket = new WebSocket('ws:10.1.5.8:8888');
               ...
               /*  var setupNewSession = document.getElementById('setup-new-session');
                ...
                setupNewSession.onclick = function() {
                    ...
                    st.get(i).getPrivateIdentity().toString()
					</td>
                    var session = { };
                    ...
                    connectist.get(i).getPrivateIdentity().toString()
					</td>on.maxParticipantsAllowed = maxParticipantsAllowed;
                    connection.open();
                }; */
                
                
                var setupNewSession = $('#setup-new-session').val();
                ...
                function scaleVideos() {
                    var videos = document.querySelectorAll('video').
                        lengst.get(i).getPrivateIdentity().toString()
						</td>th = videos.length, video;
                ...
                /* function appst.get(i).getPrivateIdentity().toString()%>&nbsp;	&nbsp;	&nbsp;	&nbsp;
				</td>endDIV(data, parent) {
