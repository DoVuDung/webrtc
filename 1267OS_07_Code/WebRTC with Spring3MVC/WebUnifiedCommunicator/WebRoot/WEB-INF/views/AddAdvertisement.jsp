...
<h2><img src="<c:url value="resources/metroui/images/advr.jpg"/> " height="50" width="150" title="CustomizeInterest"><font color=#6599FF> ADVERTISING INTERESTS </font></h2>
 <marquee behavior="ALTERNATE" direction="RIGHT"  bgcolor="#CCEEFF"; ><FONT COLOR="blue">ADVERTISE YOUR INTERESTS</FONT></marquee>
  <h1></h1>
 

<form:form method="POST" action="saveadvertisement.html">
<input type="hidden" name="pageName" value="add"/>
<table border=1px align="center" bgcolor="#CCEEFF">
<tr>
...
<form:form action="uploadimage.html" name="frm" method="POST"
...
<option value="Select"></option>
 ...
 <td><form:input path="fileVideo" id="video" type="file" /></td> 
</tr>
<tr>
