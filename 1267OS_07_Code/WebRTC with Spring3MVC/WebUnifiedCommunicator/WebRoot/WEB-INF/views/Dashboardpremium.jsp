...
function videoConf(){
	window.open('https://http://127.0.0.1:8443/Spring3WebRSecure/conferencing.html','window','width:750,height:500');
}	
...
<c:forEach var="friend" items="${friendlist}"> 
						                  ...
						                  <tr>                     
						                   ...
						                   <tr>
						                    ...
						                    <tr>
						                     ...
						                     <iframe id="iframe1" style="display:none;"  width="700" height="450" src="http://127.0.0.1:8080/Spring3WebRTCsecure/advertisement.html"></iframe> 
	...
	<a class="close-reveal-modal">&#215;</a>
						...
						<form:form method="POST" action="saveopenid.html">
					   		<table>
							    <tr>
...
<div style="height: 65%;display:none;" id="displayDetails">
	...
	<div id="geoLocationModal" class="reveal-modal xxlarge">
		...
		<script type="text/javascript">
					...
					<form:form method="POST" action="savegeolocation.html">
	   		<table>
			    <tr>
